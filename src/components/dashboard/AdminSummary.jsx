...
import { dashboardAPI } from '../../utils/analytics.utils'; // Adjust path based on your structure
...
const AdminSummary = () => {
    ...
    const completionRate = stats.totalTests > 0 
        ? ((stats.totalTests - stats.pendingReviews) / stats.totalTests * 100).toFixed(1)
        : 0;
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl p-6 md:p-8 text-white">
                <h1 className="text-2xl md:text-3xl font-bold mb-2">
                    Welcome to Diagnostic Portal
                </h1>
                <p className="text-blue-100 text-sm md:text-base">
                    Manage your diagnostic center efficiently from this dashboard
                </p>
            </div>
...
<div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    ...
    <div className="grid grid-cols-2 gap-3">
        <button 
            ...
            aria-label="Add new urodynamic report"
        >
        ...
        <button 
            onClick={() => window.location.href = '/admin-dashboard/reports?verified=false'}
